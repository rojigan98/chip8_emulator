...
int Disassemble8080Op(unsigned char *codebuffer, int pc){
  ...
  switch (*code)
  {
    ...
    case 0x3e: printf("MVI    A,#$%02x", code[1]); opbytes = 2; break; //why this inconsistency?
    ...
    case 0xc2: printf("JNZ    $%02x%02x", code[2], code[1]); opbytes = 3; break; //is this fine? or nah?
...
// need to fix part of my code, though
